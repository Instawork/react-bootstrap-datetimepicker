...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.addMinute = function () {
      return _this.setState({
        selectedDate: _this.state.selectedDate.clone().add(_this.props.stepping, "minutes")
      }, function () {
        this.props.onChange(this.state.selectedDate.format(this.props.format));
        return this.setState({
    ...
    this.subtractMinute = function () {
      return _this.setState({
        selectedDate: _this.state.selectedDate.clone().subtract(_this.props.stepping, "minutes")
      }, function () {
